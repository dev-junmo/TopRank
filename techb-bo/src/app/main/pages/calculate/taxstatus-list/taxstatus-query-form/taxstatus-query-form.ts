    ...
    @Component({
    selector: 'taxstatus-query-form',
    templateUrl: './taxstatus-query-form.html',
    styleUrls: ['./taxstatus-query-form.css'],
    })
    export class taxstatusQueryForm extends BOBaseQueryFormController {
