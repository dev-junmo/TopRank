    ...
    @Component({
    selector: 'calculate-query-form',
    templateUrl: './calculate-query-form.html',
    styleUrls: ['./calculate-query-form.css'],
    })
    export class calculateQueryForm extends BOBaseQueryFormController {
