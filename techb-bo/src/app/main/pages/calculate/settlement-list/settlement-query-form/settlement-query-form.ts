    ...
    @Component({
    selector: 'settlement-query-form',
    templateUrl: './settlement-query-form.html',
    styleUrls: ['./settlement-query-form.css'],
    })
    export class SettlementQueryForm extends BOBaseQueryFormController {

    private nowYear;
    private nowMonth;

    // public defaultStYear;
    // public defaultStMonth;
    // public defaultEdYear;
    // public defaultEdMonth;
