...
export class GenderStatisticsComponent {
    ...
    constructor(public statisticsStore: StatisticsStore,
        ...
        console.log("GenderStatisticsComponent:constructor");
    }
    ...
    reloadWithQuery(query:any) {
      ...
      this.statisticsStore.getGenderData(query).subscribe(resp => {        
        console.log('getGenderData resp =>', resp);
        this.data = resp;
        setTimeout(()=>{
          this.chart.refresh();
        }, 1);
  ...
  onClickDownloadExcel(query) {
    ...
    this.statisticsStore.downloadGenderData(query);
  }
}
