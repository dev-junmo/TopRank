...
@Component({
  selector: 'sales-statistics-query-form',
  templateUrl: './sales-statistics-query-form.html',
  styleUrls: ['./sales-statistics-query-form.css'],
})
export class SalesStatisticsQueryForm extends BOBaseQueryFormController {
    ...
    // option
    @Input() hasPayment: boolean = false;
    @Input() hasCategoryType: boolean = false;
    @Input() hasProvider: boolean = false;
