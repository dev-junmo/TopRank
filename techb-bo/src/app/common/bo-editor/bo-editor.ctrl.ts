...
@Component({
  selector: 'bo-editor',
  templateUrl: './bo-editor.ctrl.html',
  styleUrls: ['./bo-editor.ctrl.css' , '../../../assets/css/editor.css'],
  inputs: ['mceContent'],
  outputs: ['contentChanged']
})
export class BOEditorCtrl extends BOBaseForm {
    ...
    @Input() set readOnly(value) {
        ...
        //   this.tinymceConfig.readonly = value;
        // if (this.baseEditor) {
        //     this.baseEditor.readOnly = value;
        // }
    }
    ...
    public tinymceConfig = {
        ...
        plugins: 'code print preview fullpage searchreplace autolink directionality visualblocks visualchars fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists textcolor wordcount imagetools contextmenu colorpicker help',
        //toolbar: 'insertfile undo redo | styleselect | fontselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | code',
        toolbar: 'formatselect | bold italic strikethrough forecolor backcolor permanentpen formatpainter | link image pageembed | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent | removeformat | addcomment',
        image_advtab: true,
        image_title: true,
    ...
    constructor(private fileuploader: BSFileUploader, private api: BSApi) {
        super();
        self = this;
    }

    onImageUpload(blobInfo, success, failure) {
        if(blobInfo && blobInfo.blob() instanceof File) {
