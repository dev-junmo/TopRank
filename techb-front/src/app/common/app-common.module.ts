...
import { BSTab2RowComponent } from './bs-tab-2row/bs-tab-2row.component';
import { BSTab2Row2RowComponent } from './bs-tab-2row-2row/bs-tab-2row-2row.component';
import { BSMypageTabComponent } from './bs-mypage-tab/bs-mypage-tab.component';


import { SwiperComponent, SwiperDirective, SwiperConfigInterface, SwiperModule} from 'ngx-swiper-wrapper';

import { BSPeriodQueryCtrl } from './bs-period-query-ctrl/bs-period-query-ctrl';
...
/////////////////
//view
// import { ThatItemView } from './views/that-item-view/that-item.view';
// import { ThatSceneView } from './views/that-scene-view/that-scene.view';
// import { GoodsListItemView } from './views/goods-list-item-view/goods-list-item.view';
// import { GoodsPriceView } from './views/goods-price-view/goods-price.view';
...
// framework
import { BSDatatableController, BOBaseQueryFormController, BSDatatableQueryPageController } from '../../common/framework/index';
...
@NgModule({
  ...
  declarations: [
    ...
    BSTab2RowComponent,
    BSTab2Row2RowComponent,
    BSMypageTabComponent,
  ...
  exports:[
    ...
    providers: [
        // popup
        // ReviewPhotoPopupService,
        // CJPointPopupService,
        //BSVideoPlayerService,
