...
@Component({
    selector: 'popular-keyword',
    templateUrl: './popular-keyword.page.html',
    styleUrls: ['./popular-keyword.page.css']
})
export class PopularKeywordPageComponent implements OnInit {
