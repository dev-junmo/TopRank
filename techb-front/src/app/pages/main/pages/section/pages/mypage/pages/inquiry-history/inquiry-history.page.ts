...
@Component({
    selector: 'inquiry-history',
    templateUrl: './inquiry-history.page.html',
    styleUrls: ['./inquiry-history.page.css']
})
export class InquiryHistoryPageComponent implements OnInit {

    public isInquiryHistory: boolean = false;
