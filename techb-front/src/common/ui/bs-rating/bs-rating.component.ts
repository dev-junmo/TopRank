import { Component, OnInit, Input ,ViewChild, ViewEncapsulation ,ElementRef, Output, EventEmitter, TemplateRef} from '@angular/core';
...
export class BSRatingComponent implements OnInit {
  ...
  ngOnInit() {
    console.log("BSRatingComponent values=>", this.values);
  }
