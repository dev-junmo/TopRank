...
export class BSPagination implements OnInit {
    ...
    set totalItemsCount(value:number) {
        ...
        this.pager = this.getPager(this._totalItemsCount, this.currentPage);
    ...
    @Input() set setPage(page) {
        this.currentPage = page;
        this.pager = this.getPager(this._totalItemsCount, page);
        console.log('setPage page, pager =>', page, this.pager);
    }
    ...
    resetPage() {
        console.log("BSPagination:resetPage"); 
    ...
    getPager(totalItemsCount: number, currentPage: number = 1) {
        console.log('BSPagination::getPager totalItemsCount, currentPage, this.countPerPage =>', totalItemsCount, currentPage, this.countPerPage);
